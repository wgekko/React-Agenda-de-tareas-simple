...
const Formulario = ({ addTarea }) => {
    ...
    return (
        <>
            <h3 className="bg-gradient container border text-center text-light bg-dark ">Formulario</h3>
            <form className="container border text-center" onSubmit={handleSubmit}>
                <br/>
                <input
                    type="text"
                    placeholder="nombre"
